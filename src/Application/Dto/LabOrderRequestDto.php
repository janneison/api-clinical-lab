...
class LabOrderRequestDto
{
    public function __construct(
        ...
        public readonly ?int    $healthCenterId = null,   // FK opcional al catálogo
        public readonly ?int    $medicoId       = null,   // FK → medicos
        public readonly ?string $tipoDocumentoMedico  = null,
        public readonly ?string $identificacionMedico = null,
    ) {
    }
}
